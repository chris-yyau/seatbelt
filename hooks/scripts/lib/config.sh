...
# Timeouts (scanner-specific defaults in seconds)
...
SEATBELT_CHECKOV_TIMEOUT="${SEATBELT_CHECKOV_TIMEOUT:-${_SEATBELT_CFG_CHECKOV_TIMEOUT:-60}}"
SEATBELT_GITLEAKS_TIMEOUT="${SEATBELT_GITLEAKS_TIMEOUT:-${_SEATBELT_CFG_GITLEAKS_TIMEOUT:-30}}"
SEATBELT_ZIZMOR_TIMEOUT="${SEATBELT_ZIZMOR_TIMEOUT:-${_SEATBELT_CFG_ZIZMOR_TIMEOUT:-30}}"
SEATBELT_COMMITLINT_TIMEOUT="${SEATBELT_COMMITLINT_TIMEOUT:-${_SEATBELT_CFG_COMMITLINT_TIMEOUT:-10}}"
SEATBELT_SIGNING_TIMEOUT="${SEATBELT_SIGNING_TIMEOUT:-${_SEATBELT_CFG_SIGNING_TIMEOUT:-5}}"
